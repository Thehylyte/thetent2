...
export default function Index() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-tent-blue/5">
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-tent-purple/5 via-tent-blue/5 to-tent-pink/5">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover the exclusive brands and premium services that make The
              Tent the ultimate festival hospitality experience
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <p className="text-muted-foreground mb-6">
              More exclusive partnerships and premium services coming soon
            </p>
            <Button
              variant="outline"
