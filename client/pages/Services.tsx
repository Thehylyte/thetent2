        ...
        <section className="relative pt-24 min-h-screen flex items-center">
          ...
          <div className="relative z-10 container mx-auto px-6">
            <div className="text-center">
              ...
              <h1
                className="text-5xl md:text-7xl font-bold mb-6 leading-tight uppercase drop-shadow-2xl"
                style={{
                  color: "#F8F5EE",
                  fontFamily: "Inter",
                  fontWeight: "700",
              ...
              <p
                className="text-xl md:text-2xl max-w-4xl mx-auto mb-8 drop-shadow-lg"
                style={{
                  color: "#F8F5EE",
                  fontFamily: "Inter",
                  fontWeight: "300",
              ...
              {brandPartners.map((partner, index) => (
                ...
                >
                  <CardContent className="p-4">
                    ...
                    ) : partner.name === "Idle Hand Collective" ? (
                      <div className="w-16 h-16 flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <img
                          src="https://cdn.builder.io/api/v1/image/assets%2F669056b1b03f448b9ee2fa2d9e73b3a1%2F1ef858859ca74b1e80ea865750e1ed58?format=webp&width=800"
                          alt="Idle Hand Collective Logo"
                          className="w-full h-full object-contain"
                        />
                      </div>
                    ...
                    ) : partner.name === "Ving Vodka" ? (
                      <div className="w-16 h-12 flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <img
                          src="https://cdn.builder.io/api/v1/image/assets%2F669056b1b03f448b9ee2fa2d9e73b3a1%2F860b45bfa80841e3b24b39d784971c16?format=webp&width=800"
                          alt="Ving Vodka Logo"
                          className="w-full h-full object-contain"
                        />
                      </div>
